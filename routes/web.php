...
Route::group(['prefix' => 'admin', 'middleware' => ['role:admin']], function() {
    ...
    Route::resource('profiles',ProfileController::class);
      //download file
    Route::get('admin/download/{attachments}', [downloadController::class, 'getDownload'])->name('admin.download');
    //Faqs
...
Route::group(['prefix' => 'staff', 'middleware' => ['role:staff']], function() {
    ...
    Route::resource('staff_meetings',Staff_meetingController::class);
      //download file
    Route::get('staff/download/{attachments}', [Staff_downloadController::class, 'getDownload'])->name('staff.download');
...
Route::group(['prefix' => 'customer', 'middleware' => ['role:customer']], function() {
    ...
    //Orders
    Route::get('customer/download/{attachments}', [customer_OrderController::class, 'getDownload'])->name('customer.download');
