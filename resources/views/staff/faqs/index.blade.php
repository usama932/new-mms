        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span aria-hidden="true"    >
                                            ...
                                            <form action="{{ route('staff_faqs.destroy',$faq->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                ...
                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
                    ...
                    <div class="nk-block">
                        <form method ="post" action="{{route('staff_faqs.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
                                <div class="col-12">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method ="post" action="{{route('staff_faqs.update',$faq->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row g-3">
                                        <div class="col-12">
