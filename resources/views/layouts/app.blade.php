...
<head>
    ...
    <!-- StyleSheets  -->
    <!-- <link rel="stylesheet" href="{{asset('/asssts/css/custom.css')}}"> -->
    <link rel="stylesheet" href="{{asset('/assets/css/dashlite.css?ver=2.9.1')}}">
    <link id="skin-default" rel="stylesheet" href="{{asset('assets/css/dashlite.css?ver=2.9.1')}}">
</head>
<style type="text/css">
    .read-more-show{
      cursor:pointer;
                ...
                <div class="nk-sidebar-element">
                    <div class="nk-sidebar-content">
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="{{route('staffs.index')}}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-opt-alt-fill text-black"></em></span>
                                        <span class="nk-menu-text text-black">Staff</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="{{route('news.index')}}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-server-fill text-black"></em></span>
                                        <span class="nk-menu-text text-black">News</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="{{route('queries.index')}}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-chat-fill text-black"></em></span>
                                        <span class="nk-menu-text text-black">Queries</span>
                                    </a>
                                </li>
                            ...
                            <li class="nk-menu-item">
                                <a href="{{ route('meetings.index') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-server-fill"></em></span>
                                    ...
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" >
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    <li><a href="{{ route('profiles.index') }}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                                </ul>
                                            </div>
                                            <div class="dropdown-inner">
